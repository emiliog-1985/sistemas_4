...
sNext:"Siguiente",sPrevious:"Anterior"},sEmptyTable:"No data available in table",sInfo:"Mostrar _START_ de _END_ de _TOTAL_ Registros",sInfoEmpty:"Mostrar 0 de 0 de 0 Registros",sInfoFiltered:"(Se filtraron _MAX_ Registros)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ Registros",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No se encontraron resultados"},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
...
sJUIHeader:"",sJUIFooter:""});var Ob=q.ext.pager;f.extend(Ob,{simple:function(a,b){return["Anterior","siguiente"]},full:function(a,b){return["Primero","Anterior","Siguiente","Ultimo"]},numbers:function(a,b){return[ja(a,b)]},simple_numbers:function(a,b){return["previous",ja(a,b),"next"]},full_numbers:function(a,b){return["first","previous",ja(a,b),"next","last"]},first_last_numbers:function(a,b){return["first",ja(a,b),"last"]},_numbers:ja,numbers_length:7});f.extend(!0,q.ext.renderer,{pageButton:{_:function(a,b,
