...
?>
<!-- recepciones --------------------------------------------------------------------------------------------------------------------------------->
<div class="modal bd-modal-xl" id="fac" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
 ...
 <body>
<h3>Nueva factura</h3>
<form id="formacf" name="formacf" action="../modal/procesos/procesof.php" method="post">
</br>
<form>
<div class="container">
<div class="row">
...
<div class="form-group col-sm-4">
                            <p class="lead"><h6> N° de factura</p><h6>
                            <div class="help-block with-errors"></div>
                            <input name="nfac" id="nfac" placeholder="factura" maxlength="13" class="form-control" type="text" required data-error="Por favor ingresar"> 
</div>                          
