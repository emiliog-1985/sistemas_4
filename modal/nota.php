...
?>
<!-- recepciones --------------------------------------------------------------------------------------------------------------------------------->
<div class="modal bd-modal-xl" id="not" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
 ...
 <body>
<h3>Recepción</h3>
<form id="formacn" name="formacn" action="../modal/procesos/proceson.php" method="post">
</br>
<form>
<div class="container">
<div class="row">
...
<div class="form-group col-sm-4">
                            <p class="lead"><h6> N° de nota</p><h6>
                            <div class="help-block with-errors"></div>
                            <input name="nota" id="nota" placeholder="N° nota" maxlength="13" class="form-control" type="text" required data-error="Por favor ingresar"> 
                          </div>
